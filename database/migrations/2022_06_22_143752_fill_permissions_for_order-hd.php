...
class FillPermissionsForOrderHd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOrderHd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.order-hd',
            'admin.order-hd.index',
            'admin.order-hd.create',
            'admin.order-hd.show',
            'admin.order-hd.edit',
            'admin.order-hd.delete',
            'admin.order-hd.bulk-delete',
        ]);
