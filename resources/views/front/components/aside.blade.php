                        ...
                        <div id="signup1" style="display: none; opacity: 0;" data-target-group="idForm1">
                            ...
                            <div class="p-4 p-md-6">
                                <form class="registrionFrom">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="js-form-message js-focus-state">
                                            <label id="phoneNumber" class="form-label">Phone No *</label>
                                            <input type="tel" class=" form-control rounded-0 height-4 px-4 phone" name="phone" id="phoneNumber" required>
                                    ...
                                    <div class="mb-4">
                                        <input type="checkbox" required name="term"> Carefully fill this form. Fake information and data may adversely and negatively influence your account in future.
                                    </div>
                        ...
                        <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                            ...
                            <div class="p-4 p-md-6">
                                <form class="registrionFrom">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="js-form-message js-focus-state">
                                            <label id="phoneNumber2" class="form-label">Phone No *</label>
                                            <input type="tel" class="form-control rounded-0 height-4 px-4 phone" name="phone" id="phoneNumber2" required>
            ...
            <div class="u-header-sidebar__footer-offset">
                ...
                <div class="u-sidebar__body">
                    <div class="u-sidebar__content u-header-sidebar__content">
                        ...
                        <header class="border-bottom px-4 px-md-6 py-4">
                            <h2 class="font-size-3 mb-0 d-flex align-items-center"><i class="flaticon-icon-126515 mr-3 font-size-5"></i>Your shopping bag ({{count($cart)}})</h2>
                        </header>
                        ...
                        <div class="px-4 py-5 px-md-6 border-bottom">
                            <div class="media">
                                <a href="{{url('book',$book->slug)}}" class="d-block"><img src="{{ $bookImageUrl}}" class="img-fluid" alt="image-description"></a>
                                <div class="media-body ml-4d875">
                                    <div class="text-primary text-uppercase font-size-1 mb-1 text-truncate"><a href="#">PaperBook</a></div>
                                    <h2 class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2">
                                        <a href="{{url('book',$book->slug)}}" class="text-dark">{{$book->title}}</a>
                                    </h2>
                                    ...
                                    <div class="price d-flex align-items-center font-weight-medium font-size-3">
                                        <span class="woocommerce-Price-amount amount">{{$item->quantity}} x <span class="woocommerce-Price-currencySymbol">{{$website->currency_symbol}} </span>{{$amount}}</span>
                                    </div>
                                </div>
                                <div class="mt-3 ml-3">
                        ...
                        <div class="px-4 py-5 px-md-6 d-flex justify-content-between align-items-center font-size-3">
                            <div class="font-weight-medium">Cart is empty</div>
                        </div>
                        @endif
                        ...
                        <div class="px-4 py-5 px-md-6 d-flex justify-content-between align-items-center font-size-3">
                            ...
                            <div class="font-weight-medium">{{$website->currency_symbol}} {{$total}}</div>
                        </div>
                        <div class="px-4 mb-8 px-md-6">
                            <a href="{{url('cart')}}" class="btn btn-block py-4 rounded-0 btn-outline-dark mb-4">View Cart</a>
                    ...
                    <div class="u-sidebar__content u-header-sidebar__content">
                        ...
                        <div class="border-bottom">
                            <div class="zeynep pt-4">
                                <ul>
                                    <li class="{{ Request::is('/')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('/')}}" data-submenu="off-pages">Home</a>
                                    </li>
                                    <li class="{{ Request::is('books')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('books')}}" data-submenu="off-pages">Books</a>
                                    </li>
                                    <li class="{{ Request::is('about-us')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('about-us')}}" data-submenu="off-pages">About Us</a>
                                    </li>
                                    <li class="{{ Request::is('contact-us')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('contact-us')}}" data-submenu="off-pages">Contact Us</a>
                                    </li>
                        ...
                        <div class="px-4 px-md-5 pt-5 pb-4 border-bottom">
                            ...
                            <ul class="list-group list-group-flush list-group-borderless">
                                ...
                                @if (Auth::guest())
                                <li class="list-group-item px-0 py-2 border-0"><a href="{{url('login')}}" class="h-primary">Sign In</a></li>
                                @else
                                <li class="list-group-item px-0 py-2 border-0"><a href="{{url('dashboard')}}" class="h-primary">Your Account</a></li>
