                            ...
                            <div class="card-statistic-3 p-4">
                                    ...
                                    <div class="col-12">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                @php
                                                    /*if $quiz->quiz_in = 0 then select the description of the secion*/
                                                    if($quiz->quiz_in_section != 0){
                                                        $section = DB::table('sections')->where('id', $quiz->quiz_in_section)->first();
                                                        $description = $section->description;
                                                    }else{
                                                        $description = DB::table('units')->where('id', $quiz->quiz_in_unit)->first()->description;
                                                    }
                                                @endphp
                                                <tr>
                                                    <th>
                                ...
                                <div class="row align-items-center text-black  p-2 d-flex">
                                    <div class="mb-5 col-sm-6">
                                        ...
                                        {!!Share::page(url('result/details', base64_encode($quiz->id)), 'Bettani Series Result')
                                        ->facebook()
                                        ->twitter()
                                        ->linkedin('e')
                                        ->whatsapp();!!}
                                    ...
                                    <div class="mb-5 col-sm-6">
                                        ...
                                        <!-- <button class="btn mb-3 mr-3 btn-primary"><span>Share</span></button> -->
                                        <form class="d-inline" action="wrong-questions" method="post" id="wrong_question_form">
                                            @csrf
                                            <input type="hidden" name="quiz_id" value="{{ $quiz->id}}">
                                            {{-- <a onclick="document.getElementById('wrong_question_form').submit();"  class="ml-2 btn btn-danger" href="#">Wrong Questions</a> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#btndownload").click(function() {
                ...
                var options = {
                    margin: 1,
                    filename: '{{ Auth::user()->name }}' + "_Result" + '.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 0.98
                    },
